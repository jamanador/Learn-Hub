...
const Profile = () => {
    ...
    return (
        <div className="max-w-md p-8 sm:flex sm:space-x-6 mx-auto border border-purple-400 my-4">
        <div className="flex-shrink-0 w-full mb-6 h-44 sm:h-32 sm:w-32 sm:mb-0 justify-center">
          <img
            src={
              user.photoURL ? (
                user.photoURL
