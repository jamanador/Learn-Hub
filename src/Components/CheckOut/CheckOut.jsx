...
const handleToast = ()=>{
  ...
  return (
    <div
      className="mx-auto container flex flex-col max-w-3xl p-6 space-y-4 sm:p-10 dark:text-white text-gray-900"
    ...
    >
      ...
      <ul className="flex flex-col divide-y divide-gray-700">
        <li className="flex flex-col py-6 sm:flex-row sm:justify-between">
          <div
            className="flex w-full space-x-2 pr-4 p-4 sm:space-x-4 border"
          >
            <img
