        ...
        >
          <div className="space-y-1 text-sm">
            ...
            <input
              ...
              id="name"
              placeholder="Name"
              className="w-full px-4 py-3 rounded-md border border-gray-700 bg-gray-900 dark:text-gray-100 focus:border-violet-400"
            />
          </div>
          <div className="space-y-1 text-sm">
          ...
          <div className="text-white flex">
            ...
            />
            <label htmlFor="checkbox" className="block text-gray-400">
              Accept <Link to="/terms">Terms & Condions</Link>
            </label>
          </div>
          <button
            type="submit"
