...
const Allusers = () => {
  ...
  return (
    ...
    //           <td>{user?.email}</td>
    //           <td>
    //             <button className="border text-primary p-1">Make Admin</button>
    //           </td>
    //           <td>
    //             <button>
    //               {" "}
    ...
    <div className="container mx-auto dark:text-black dark:customColor">
      <h3 className="text-center font-bold py-6">All Users</h3>
        ...
        <table className="table w-full dark:customColor">
          ...
          <tbody className="dark:bg-red-500">
            {users?.map((user, index) => (
             ...
             <td><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" class="w-6 h-6">
